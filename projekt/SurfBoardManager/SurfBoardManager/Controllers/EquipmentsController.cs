...
namespace SurfBoardManager.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public EquipmentsController(SurfBoardManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Equipment != null ? 
                          ...
                          Problem("Entity set 'SurfBoardManagerContext.Equipment'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SurfBoardManagerContext.Equipment'  is null.");
            }
            var equipment = await _context.Equipment.FindAsync(id);
            if (equipment != null)
            {
